...
class CreatWordCloud:
    def __init__(self, background_color: str, width: int=900, height: int=500):
    ...
    def create_wordcloud(self, month, sex, text: str):
        ...
        wordcloud = WordCloud(background_color=self.background_color, font_path=self.font_path, width=self.width, height=self.height, \
                          stopwords=set(self.stopwords)).generate(text)
...
if __name__ == "__main__":
    CWC = CreatWordCloud(background_color="white", width=900, height=500)
